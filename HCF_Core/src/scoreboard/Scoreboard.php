...
class Scoreboard {
     ...
     * @return void
     */
	public function newScoreboard(Session $player, string $objectiveName, string $displayName) : void { 
     ...
     * @return void
     */
	public function remove(Session $player) : void {
		if(isset(self::$scoreboards[$player->getName()])){
     ...
     * @return void
     */
	public function setLine(Session $player, int $score, ?string $message) : void {
		if(!isset(self::$scoreboards[$player->getName()])){
     ...
     * @return string|null
     */
	#[Pure] public function getObjectiveName(Session $player) : ?string {
